...
export const WaveformDisplay: React.FC<WaveformDisplayProps> = ({ waveformData, progress, beatMarkers, isActive }) => {
	...
	return (
		<div ref={containerRef} className='waveform-container'>
			...
			{/* Progress indicator */}
			<div className='waveform-progress' style={{ left: `${progress * 100}%` }} />
